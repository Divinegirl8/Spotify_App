  ...
  List<Music> musicList = [];
   static const trackIds = [
    '5ZtK8XAVnoaGdBXZWCEVCY',
      ...
      '75c5cm8y5Fzb6aTZM3MOpN',
      '2Ydj7wgn4ZrFFQsfFBTTYJ',
      '1IMRi5UVOV77PsAgdWDvzh',
      '5mjxSIPHAMNk40q0nON5Cb',
                        ...
                        flut.Column(
                          ...
                          children: [
                            flut.Text(
                              ...
                              style: textTheme.titleMedium?.copyWith(color: flut.Colors.white),
                            ),
                            flut.Text(
                              musicList.isNotEmpty ? musicList[currentTrackIndex].artistName ?? '-' : '-',
                              style: textTheme.titleSmall?.copyWith(color: flut.Colors.white60),
                            ),
                          ],
                        ),
                        const flut.Icon(
